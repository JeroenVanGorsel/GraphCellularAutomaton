/**
 * graphs/graph.js — Graph (directed, undirected, or bidirectional) as a sparse adjacency matrix.
 *
 * EDGE TYPES
 * ----------
...
if (typeof module !== 'undefined' && module.exports) {
  module.exports = { SparseAdjacencyMatrix, Graph, DirectedGraph };
} else {
  window.GraphCA = window.GraphCA || {};
  Object.assign(window.GraphCA, { SparseAdjacencyMatrix, Graph, DirectedGraph });
}
